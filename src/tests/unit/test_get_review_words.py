...
def mocked_list_id_query(list_id, from_date, todays_date):
  ...
  return [{'SK': 'DATESENT#2020-10-10', 'PK': 'LIST#1ebcad3f-5dfd-6bfe-bda4-acde48001122', 'Word': {'list_id': 'LIST#123456', 'word_id': 'WORD#123456', 'word': { 'Simplified': '多少', 'Pinyin': 'duō shǎo', 'Definition': 'number; amount; somewhat', 'HSK Level': '1', 'Traditional': '多少', 'Difficulty level': 'Beginner', 'Audio file key': ''}}}, {'SK': 'DATESENT#2020-10-11', 'PK': 'LIST#1ebcad3f-5dfd-6bfe-bda4-acde48001122', 'Word': {'list_id': 'LIST#123456', 'word_id': 'WORD#123456', 'word': { 'Simplified': '怎么', 'Pinyin': 'zěn me', 'Definition': 'how?; what?; why?', 'HSK Level': '1', 'Traditional': '怎麼', 'Difficulty level': 'Beginner', 'Audio file key': ''}}}, {'SK': 'DATESENT#2020-10-12', 'PK': 'LIST#1ebcad3f-5dfd-6bfe-bda4-acde48001122', 'Word': {'list_id': 'LIST#123456', 'word_id': 'WORD#123456', 'word': { 'Simplified': '吗', 'Pinyin': 'ma', 'Definition': '(question tag)', 'HSK Level': '1', 'Traditional': '嗎', 'Difficulty level': 'Beginner', 'Audio file key': ''}}}]
